    ...
    pub fn from_byte(byte: u8, prefix_instruction: bool) -> Option<Instruction> {
        if !prefix_instruction {
            ...
            match byte {
                ...
                0xC0 => Some(Instruction::SET(0, ArithmeticSource::B)),
                0xC1 => Some(Instruction::SET(0, ArithmeticSource::C)),
                0xC2 => Some(Instruction::SET(0, ArithmeticSource::D)),
                0xC3 => Some(Instruction::SET(0, ArithmeticSource::E)),
                0xC4 => Some(Instruction::SET(0, ArithmeticSource::H)),
                0xC5 => Some(Instruction::SET(0, ArithmeticSource::L)),
                0xC6 => Some(Instruction::SET(0, ArithmeticSource::HL_INDIRECT)),
                0xC7 => Some(Instruction::SET(0, ArithmeticSource::A)),
                0xC8 => Some(Instruction::SET(1, ArithmeticSource::B)),
                0xC9 => Some(Instruction::SET(1, ArithmeticSource::C)),
                0xCA => Some(Instruction::SET(1, ArithmeticSource::D)),
                0xCB => Some(Instruction::SET(1, ArithmeticSource::E)),
                0xCC => Some(Instruction::SET(1, ArithmeticSource::H)),
                0xCD => Some(Instruction::SET(1, ArithmeticSource::L)),
                0xCE => Some(Instruction::SET(1, ArithmeticSource::HL_INDIRECT)),
                0xCF => Some(Instruction::SET(1, ArithmeticSource::A)),
                0xD0 => Some(Instruction::SET(2, ArithmeticSource::B)),
                0xD1 => Some(Instruction::SET(2, ArithmeticSource::C)),
                0xD2 => Some(Instruction::SET(2, ArithmeticSource::D)),
                0xD3 => Some(Instruction::SET(2, ArithmeticSource::E)),
                0xD4 => Some(Instruction::SET(2, ArithmeticSource::H)),
                0xD5 => Some(Instruction::SET(2, ArithmeticSource::L)),
                0xD6 => Some(Instruction::SET(2, ArithmeticSource::HL_INDIRECT)),
                0xD7 => Some(Instruction::SET(2, ArithmeticSource::A)),
                0xD8 => Some(Instruction::SET(3, ArithmeticSource::B)),
                0xD9 => Some(Instruction::SET(3, ArithmeticSource::C)),
                0xDA => Some(Instruction::SET(3, ArithmeticSource::D)),
                0xDB => Some(Instruction::SET(3, ArithmeticSource::E)),
                0xDC => Some(Instruction::SET(3, ArithmeticSource::H)),
                0xDD => Some(Instruction::SET(3, ArithmeticSource::L)),
                0xDE => Some(Instruction::SET(3, ArithmeticSource::HL_INDIRECT)),
                0xDF => Some(Instruction::SET(3, ArithmeticSource::A)),
                0xE0 => Some(Instruction::SET(4, ArithmeticSource::B)),
                0xE1 => Some(Instruction::SET(4, ArithmeticSource::C)),
                0xE2 => Some(Instruction::SET(4, ArithmeticSource::D)),
                0xE3 => Some(Instruction::SET(4, ArithmeticSource::E)),
                0xE4 => Some(Instruction::SET(4, ArithmeticSource::H)),
                0xE5 => Some(Instruction::SET(4, ArithmeticSource::L)),
                0xE6 => Some(Instruction::SET(4, ArithmeticSource::HL_INDIRECT)),
                0xE7 => Some(Instruction::SET(4, ArithmeticSource::A)),
                0xE8 => Some(Instruction::SET(5, ArithmeticSource::B)),
                0xE9 => Some(Instruction::SET(5, ArithmeticSource::C)),
                0xEA => Some(Instruction::SET(5, ArithmeticSource::D)),
                0xEB => Some(Instruction::SET(5, ArithmeticSource::E)),
                0xEC => Some(Instruction::SET(5, ArithmeticSource::H)),
                0xED => Some(Instruction::SET(5, ArithmeticSource::L)),
                0xEE => Some(Instruction::SET(5, ArithmeticSource::HL_INDIRECT)),
                0xEF => Some(Instruction::SET(5, ArithmeticSource::A)),
                0xF0 => Some(Instruction::SET(6, ArithmeticSource::B)),
                0xF1 => Some(Instruction::SET(6, ArithmeticSource::C)),
                0xF2 => Some(Instruction::SET(6, ArithmeticSource::D)),
                0xF3 => Some(Instruction::SET(6, ArithmeticSource::E)),
                0xF4 => Some(Instruction::SET(6, ArithmeticSource::H)),
                0xF5 => Some(Instruction::SET(6, ArithmeticSource::L)),
                0xF6 => Some(Instruction::SET(6, ArithmeticSource::HL_INDIRECT)),
                0xF7 => Some(Instruction::SET(6, ArithmeticSource::A)),
                0xF8 => Some(Instruction::SET(7, ArithmeticSource::B)),
                0xF9 => Some(Instruction::SET(7, ArithmeticSource::C)),
                0xFA => Some(Instruction::SET(7, ArithmeticSource::D)),
                0xFB => Some(Instruction::SET(7, ArithmeticSource::E)),
                0xFC => Some(Instruction::SET(7, ArithmeticSource::H)),
                0xFD => Some(Instruction::SET(7, ArithmeticSource::L)),
                0xFE => Some(Instruction::SET(7, ArithmeticSource::HL_INDIRECT)),
                0xFF => Some(Instruction::SET(7, ArithmeticSource::A)),
                _ => None,
            }
        }
    }
